...
mixin _$LoginController on LoginControllerBase, Store {
  ...
  late final _$obscuredTextAtom =
      Atom(name: 'LoginControllerBase.obscuredText', context: context);
  ...
  late final _$errorLoginModelAtom =
      Atom(name: 'LoginControllerBase.errorLoginModel', context: context);
  ...
  void upadateEmail(String newValue) {
    final _$actionInfo = _$LoginControllerBaseActionController.startAction(
        name: 'LoginControllerBase.upadateEmail');
    try {
  ...
  void updatePassword(String newValue) {
    final _$actionInfo = _$LoginControllerBaseActionController.startAction(
        name: 'LoginControllerBase.updatePassword');
    try {
  ...
  void updateObscuredText(bool newValue) {
    final _$actionInfo = _$LoginControllerBaseActionController.startAction(
        name: 'LoginControllerBase.updateObscuredText');
    try {
  ...
  void setLoginInfoState(ErrorLoginModel newValue) {
    final _$actionInfo = _$LoginControllerBaseActionController.startAction(
        name: 'LoginControllerBase.setLoginInfoState');
    try {
